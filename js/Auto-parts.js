...
let categories = [
    ...
    new PartsCategory('Автохимия', '####.html'),
    new PartsCategory('Автоэлектрика', '#######.html'),
...
function renderCategories() {
    ...
    contAuto.appendChild(wrapper);
    
}
renderCategories('#contAuto');